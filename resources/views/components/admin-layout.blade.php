...
<head>
    ...
    <title>{{ config('app.name', 'EventHub') }} - Admin</title>
        ...
        <div class="flex">
            <div class="fixed inset-y-0 left-0 w-64 bg-white shadow-md z-10">
                ...
                <div class="flex items-center justify-center h-16 border-b">
                    <h1 class="text-xl font-bold text-blue-600">EventHub Admin</h1>
                </div>
                ...
                <nav class="mt-6">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('admin.event-approvals') }}" class="flex items-center px-6 py-3 hover:bg-gray-100 {{ request()->routeIs('admin.event-approvals') ? 'sidebar-active' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li>
                            <a href="{{ route('admin.feedback') }}" class="flex items-center px-6 py-3 hover:bg-gray-100 {{ request()->routeIs('admin.feedback') ? 'sidebar-active' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li>
                            <a href="{{ route('admin.reports') }}" class="flex items-center px-6 py-3 hover:bg-gray-100 {{ request()->routeIs('admin.reports') ? 'sidebar-active' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
